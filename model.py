...
Topology: ULTRA-CONSERVATIVE stress test. Single rectangular silicon cantilever,
          single-sided coating, no array, 5nm amplitude, L/t >= 100.
          Tests the absolute physical limit of the simplest possible sensor.
...
A_OSC    = 5e-9       # oscillation amplitude [m] (5 nm — ultra-conservative)


def run_simulation(params):
    """
    ULTRA-CONSERVATIVE: Si cantilever, double-sided coat, small array,
    5nm amplitude, L/t >= 100. Rescued with topology enhancements.
    ...
    A_coat = 2 * w * L  # double-sided coating
    ...
    delta_m_min = delta_m_min / np.sqrt(N_array)  # array averaging
